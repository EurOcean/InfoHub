        ...
        <div class="w-full md:py-14">
            ...
            <div class="flex items-center space-x-2 my-8">
                <div class="flex items-center flex-grow space-x-2 mb-4">
                    ...
                    <div><p class="text-primary-blue capitalize"><strong>{{ $project->acronym }}</strong></p></div>
                </div>
                <div><a class="bg-primary-blue px-4 py-2 text-sm text-white font-bold rounded shadow uppercase" href="{{ url('api/v1/project') }}/{{ $project->projectID }}" target="_blank"><strong>json</strong></a></div>
            </div>
                ...
                <div>
                    <dl>
                        ...
                        <div class="bg-gray-50 px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 mt-4">
                            <dt class="text-sm font-medium text-gray-500">Coodinators:</dt>
                        </div>
                        <div class="px-6 bg-gray-50">
                            <table class="table-auto w-full mx-auto">
                                ...
                                <tbody class="text-sm text-gray-900">
                                    ...
                                    <tr class="border-b">
                                        <td class="px-4 py-2">
                                            @if ($coordinator->institution_name === '')
                                                <p class="text-gray-400">Not available</p>
                                            @else
                                                <!-- {{ $coordinator->institution_name }}</p> -->
                                                <a class="text-blue-500 hover:text-blue-900" href="/organization/{{$coordinator->id_relation}}">
                                                    {{ $coordinator->institution_name }}
                                                </a>
                                            @endif
                                        </td>
                                            <td>
                                            @if ($coordinator->institution_acronym === '')
                                                <p class="text-gray-400">Not available</p>
                                            @else
                                                {{ $coordinator->institution_acronym }}</p>
                                            @endif
                                        </td>
                                        <td>
                                            @if ($coordinator->country_name === '')
                                                <p class="text-gray-400">Not available</p>
                                            @else
                                                {{ $coordinator->country_name }}</p>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        <div class="bg-white px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 mt-2">
                        ...
                        <div class="px-6">
                            <table class="table-auto w-full mx-auto">
                                ...
                                <tbody class="text-sm text-gray-900">
                                    ...
                                    <tr class="border-b">
                                        <td class="px-4 py-2">
                                            @if ($partner->institution_name === '')
                                                <p class="text-gray-400">Not available</p>
                                            @else
                                                <a class="text-blue-500 hover:text-blue-900" href="/organization/{{$partner->id_relation}}">
                                                    {{ $partner->institution_name }}
                                                </a>
                                            @endif
                                        </td>
                                            <td>
                                            @if ($partner->institution_acronym === '')
                                                <p class="text-gray-400">Not available</p>
                                            @else
                                                {{ $partner->institution_acronym }}</p>
                                            @endif
                                        </td>
                                        <td>
